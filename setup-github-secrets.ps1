...
function Set-GitHubSecrets {
    ...
    Set-GitHubSecret "LAMBDA_FUNCTION_NAME" "Lambda function name (e.g., whatsapp-webhook)"
...
function Show-NextSteps {
    ...
    Write-Host "   git add ."
    Write-Host "   git commit -m 'Deploy WhatsApp webhook'"
    Write-Host "   git push origin main"
    Write-Host ""
    Write-Host "2. GitHub Actions will automatically deploy to AWS Lambda"
    Write-Host ""
    Write-Host "3. Get your webhook URL from AWS console or GitHub Actions output"
    Write-Host ""
    Write-Host "4. Configure your WhatsApp Business API with the webhook URL"
    Write-Host ""
