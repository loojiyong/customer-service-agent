...
show_next_steps() {
    ...
    echo "   git add ."
    echo "   git commit -m 'Add WhatsApp webhook with GitHub Actions'"
    echo "   git push origin main"
    echo ""
    echo "2. The GitHub Action will automatically deploy to AWS Lambda"
    echo ""
    echo "3. Get your webhook URL from the GitHub Actions output or AWS console"
    echo ""
    echo "4. Configure your WhatsApp Business API:"
    echo "   - Webhook URL: https://your-api-id.execute-api.ap-southeast-1.amazonaws.com/dev/webhook"
